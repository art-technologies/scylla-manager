...
// ConnectConfig is the configuration of the connection exposed to users.
...
func DefaultConfig() Config {
	return DefaultConfigWithConnect(DefaultConnectConfig())
}

func DefaultConfigWithConnect(c ConnectConfig) Config {
	return Config{
		Port:          "10001",
		ConnectConfig: c,
	}
